...
public static class ResourceBank
{
    ...
    public static class String
    {
        ...
        public static readonly string AutoHelpListRecipesOnThingsUnlocked =
        ...
        public static readonly string AutoHelpListVerbs = "AutoHelpListVerbs".Translate();
        public static readonly string AutoHelpListTools = "AutoHelpListTools".Translate();
